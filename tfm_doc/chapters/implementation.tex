...
Para configurar Travis CI, el primer paso es almacenar las credenciales de DockerHub en el fichero \kode{.travis.yml}. Esto se hará utilizando variables de entorno, ejecutando lo siguiente, que dará la versión segura y las almacenará en el fichero.
