...
Las características de la arquitectura Ruby on Rails que implementa la aplicación son:
\begin{itemize}
...
Para poder crear un contenedor que contenga la aplicación web habrá que crear su imagen Docker, que se llamará \kode{sample\_app\_rails\_4\_image}. A efectos de mantenerla remotamente se subirá al repositorio DockerHub con la etiqueta \kode{initial}.
...
En esta iteración se ha conseguido el despligue de un clúster compuesto de tres instancias en la nube pública de Amazon Web Services.
