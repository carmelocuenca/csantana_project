...
Además, hay que indicar la redirección de puertos del 8080 del sistema anfitrión al 80 de CoreOS. Para ello se añade la siguiente línea, dentro del fichero \kode{Vagrantfile}:
...
El despliegue ideal de la aplicación a través de las unidades de servicio que la componen sería de manera automática. Esto se implementa en CoreOS a partir del fichero denominado \kode{cloud-config} que se corresponde con \kode{user-data} de manera que se especifica el orden de las unidades ha desplegar y las acciones de habilitación y comienzo de los servicios a los que hacen referencia.
