...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/figures/containervsmv.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{images/figures/dockerarchitecture.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/figures/coreosarchitecture.png}
