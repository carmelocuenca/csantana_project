...
Otra tecnología de contenedores es rkt\footnotettt{rkt}{https://coreos.com/rkt}, software de código abierto del equipo que desarrolla CoreOS\footnotettt{CoreOS}{https://coreos.com}. 
...
Los principales componentes de CoreOS son su núcleo, systemd\footnotettt{systemd}{https://coreos.com/docs/launching-containers/launching/getting-started-with-systemd}, etcd\footnotettt{etcd}{https://coreos.com/etcd}, fleet\footnotettt{fleet}{https://coreos.com/fleet} y flannel\footnotettt{flannel}{https://coreos.com/flannel/docs/latest/flannel-config.html}. Como parte de su ecosistema se tiene Docker y Kubernetes\footnotettt{Kubernetes}{http://kubernetes.io}, este último explicado en el siguiente capítulo.
...
Cuando esté funcionando se podrán agregar nuevos contenedores de apache que, a su vez, se asignen automáticamente al balanceador de carga.
...
\footnotetext{Ramblings. (2015). Load balancing with coreos, confd and nginx [Figura]. Recuperado de \url{http://blog.dixo.net/2015/02/load-balancing-with-coreos}}
...
La unidad más pequeña en Kubernetes es un \textit{pod}. Los \textit{pods} son un conjunto de contenedores que se encuentran juntos en un único nodo, trabajando estrechamente entre sí. Cada \textit{pod} tiene una dirección IP y todos los contenedores de ese \textit{pod} la comparten. Los \textit{pods} pueden hablar entre sí a través de los nodos utilizando diferentes técnicas como el enrutamiento basado en la nube, Flannel, Weave\footnotettt{Weave}{https://developers.google.com/weave}, Calico\footnotettt{Calico}{https://www.projectcalico.org/learn} y otros.
